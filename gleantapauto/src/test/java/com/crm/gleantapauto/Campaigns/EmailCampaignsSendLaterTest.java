...
public class EmailCampaignsSendLaterTest extends BaseTest{
	
	@Test
	public void CreateAndSendLaterCampaign() throws InterruptedException
	{
		...
		Campname.click();
		Campname.sendKeys("AutoCampaignSendLater");
	...
	wait.until(ExpectedConditions.visibilityOf(test));
	 action.moveToElement(test);
       ...
       wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//span[contains(text(),'SAVE')]/parent::button")));
		...
		WebElement save3=driver.findElement(By.xpath(".//*[@id='saveCampaign']"));
		action.moveToElement(save3);
		save3.click();
		...
		System.out.println("clicked on Review & Send");
		WebElement SendLater=driver.findElement(By.xpath(".//*[@id='sendlater']/.."));
		/*if(wait.until(ExpectedConditions.visibilityOf(SendLater)).isDisplayed())
		{*/
			driver.findElement(By.xpath(".//*[@id='sendlater']/..")).click();
			
			driver.findElement(By.xpath(".//*[@name='start_date_value']")).sendKeys("30-12-2024");
			driver.findElement(By.xpath(".//*[@name='start_time_value']")).sendKeys("8:00 PM");
			driver.findElement(By.xpath(".//*[@name='start_time_value']")).click();
	//	}
		driver.findElement(By.xpath(".//*[@id='saveCampaign']")).click();
		System.out.println("clicked on the send campaign");
