...
public class EmailCampaignOngoingTest extends BaseTest{
	
	@Test
	public void CreateAndSendOngoingCampaign() throws InterruptedException
	{
		...
		Campname.click();
		Campname.sendKeys("AutoCampaignOngoing");
	...
	wait.until(ExpectedConditions.visibilityOf(test));
	 action.moveToElement(test);
       ...
       wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//span[contains(text(),'SAVE')]/parent::button")));
		...
		{*/
			driver.findElement(By.xpath("//*[@id='automated']/..")).click();
